...
ROBOTWIN_SPLIT_RANK_LOG_DIR=/home/chw/code/packages/OpenWAM/train-on-robotwin/code/audit/rank_logs/formal_action_only_no_wm_50k_${RUN_STAMP} \
MASTER_PORT=29620 \
...
ROBOTWIN_SPLIT_RANK_LOG_DIR=/home/chw/code/packages/OpenWAM/train-on-robotwin/code/audit/rank_logs/formal_wm_50k_${RUN_STAMP} \
MASTER_PORT=29621 \
bash /home/chw/code/packages/OpenWAM/train-on-robotwin/code/train_robotwin_split.sh \
  "${COMMON_ARGS[@]}" \
